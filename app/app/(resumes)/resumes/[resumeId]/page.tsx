					...
					<div className="md:px-8  p-4 flex-col flex w-[400px] h-full bg-blue-800">
						...
						<div className="mt-8 md:mt-0 w-full flex flex-col">
							<p className="mt-2 text-gray-50 text-md font-bold w-full">
								Get specific, actionable feedback on how to improve your resume.
								The Al will highlight areas for improvement and provide clear
								recommendations to help you make your resume stand out for your
