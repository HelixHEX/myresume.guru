	...
	return (
		<div className="w-full flex flex-col h-full overflow-y-scroll">
			<div className="flex h-full">
				<div className="h-full p-4 px-4 sm:px-8 transition-all duration-300 w-full lg:w-[700px] ">
							...
							<Tabs defaultValue="edit" className="w-full">
								<div className="flex gap-4">
									...
									<TabsList className="self-center">
										<TabsTrigger
											className="cursor-pointer text-white data-[state=active]:text-white data-[state=active]:bg-blue-800 bg-white rounded-none border-none"
											value="edit"
										>
											Edit
										</TabsTrigger>
