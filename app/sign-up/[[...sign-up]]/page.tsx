...
export default function Page() {
	return (
		// <div className="flex items-center flex-row gap-10 justify-center self-center h-screen w-full">
		// 	<div className="relative bg-blue-800 hidden sm:block transition-all duration-300 w-1/2 h-full">
		...
		// 	</div>
		// 	<div>
		// 		<div className="flex w-full sm:w-1/2 items-center flex-col gap-2">
		// 			<h1 className="text-4xl font-bold text-dark-gray">
		// 				MyResume.<span className="text-blue-800">Guru</span>
		// 			</h1>
		// 			<p className="font-medium">Create a free account to get started</p>
		// 		</div>
		// 		<SignUp path="/sign-up" />
		// 	</div>
		// </div>
