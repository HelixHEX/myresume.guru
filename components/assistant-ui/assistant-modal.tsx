...
export const AssistantModal: FC = () => {
  ...
  return (
    <AssistantModalPrimitive.Root>
      ...
      >
        {(user!.unsafeMetadata.messageCount as number) >= 10 &&
        user!.unsafeMetadata.plan !== "Plus" ? (
          <div className="flex flex-col text-center items-center justify-center h-full">
            <h1 className="text-lg w-full sm:w-3/4 font-bold">
              Thanks for using the Resume Guru{" "}
              {user!.unsafeMetadata.plan === "Plus" ? "Plus" : "Assistant"}!
            </h1>
            <p className="text-sm w-full sm:w-4/5 mt-2">
              You have reached the limit of your free trial. Please upgrade to
