...
export default function ResumeCard({ name, fileKey, createdAt }: Resume) {
	...
	return (
		<Card
			...
			className="w-full hover:bg-dark-gray hover:text-white hover:cursor-pointer flex flex-row p-0 h-[50px] rounded-none border-t-[0.02px] border-x-0 border-b-[0.02px] border-gray-200"
		>
